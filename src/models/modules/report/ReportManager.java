...
public class ReportManager {
    ...
    public boolean createDailyPeriodicSales(ReportTimePeriods.TimePeriod timePeriod, String date) {
        try (PdfWriter writer = new PdfWriter(REPORTS_FOLDER_PATH + timePeriod.getPeriodString() + "PeriodicReport_"
