...
public class IncrementStockInventoryModel {
    ...
    public boolean logStockProductPurchase(Stock selectedStock, int quantity, float totalCost, LocalDate datePurchased,
        ...
        return this.controller.getDBManager().query.logStockProductPurchase(selectedStock, quantity, totalCost,
                datePurchased, expiryDate, stockProductTypeID, loggedInUser);
    }
