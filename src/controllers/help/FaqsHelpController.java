...
public class FaqsHelpController extends ParentController {
    ...
    private void q1(ActionEvent e) {
        FaqAnswerController controller = (FaqAnswerController) this
                .initializeNextScreen_BP(ScreenPaths.Paths.FAQS_ANSWER.getPath(), loggedInUserInfo, "FAQ");
    ...
    private void q7(ActionEvent e) {
        FaqAnswerController controller = (FaqAnswerController) this
                .initializeNextScreen_BP(ScreenPaths.Paths.FAQS_ANSWER.getPath(), loggedInUserInfo, "FAQ");
        controller.initialize(
                " For support, click on the 'Help' button on the main menu and select 'Contact Support.' You can reach us via email, phone, or live chat during business hours.");
    }
